 ...
 * StoreCrawler
 *
 * A class consisting of static methods to retrieve user genres of a game. This
 * is an optional feature and is set as an option in the Settings.
 *
 * If Steam changes its layout this class will not work and will always return
 * an APIEmptyResponse exception.
 *
...
public class StoreCrawler{
	 ...
	 * retrieveJSONString
	 *
	 * Given that user genres are displayed by a javascript function that is
	 * provided JSON array of genres, extract the JSON.
	 *
	 * Ex: InitAppTagModal( 392620,
	 ...
	 * retrievePage
	 *
	 * Will send a GET request to the store front to get the HTML of the page
	 * for the appid.
	 *
	 * @param appid of game
	 ...
	 * getUserGenres
	 *
	 * Get user genres of a specified appid. This is an optional feature for a
	 * user as it depends on the storefront page layout staying the same.
	 *
